  ...
  axios
    ...
    .then(response => {
      if (response.status === 200) {
        ...
        const html = response.data;
        const $ = cheerio.load(html);
        let temp = $('span[class="_3KcTQ"]').text();
        let desc = $('div[class="_2xXSr"]').text();
        let feels = $('span[class="_2aogo"]').text();
        let location = $('h1[class="_1Ayv3"]').text();
        let prec = $('div[class="RBVJT"]').text();
